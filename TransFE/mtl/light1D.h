...
public:
  ...
  ///
#elif defined( _MSVCPP7_ ) && (_MSC_VER <= 1300)
  ...
  // According to Jean-Raynald de Dreuzy and Romain Le Goc current versions
  // of visual C++ 7.0 don't have _Ptrit anymore. As we dont know from which version
  // on, we leave the following code as comment.
// #if defined(_MSVCPP_)   
//   typedef dense_iterator<T, 0, IND_OFFSET> iterator;   
//   typedef dense_iterator<T, 1, IND_OFFSET> const_iterator;   
// #else   
